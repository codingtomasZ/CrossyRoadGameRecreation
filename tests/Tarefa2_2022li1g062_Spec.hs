...
testsT9 :: Test 
testsT9 = TestLabel "Teste indicador do sentido" $ test ["Teste velocidade negativa Estrada" ~: False ~=? velocidade_positiva (Estrada (-2), [Carro, Nenhum , Nenhum , Carro ]) ]

testsT10 :: Test 
testsT10 = TestLabel "Teste indicador do sentido" $ test ["Teste velocidade positiva Estrada" ~: True ~=? velocidade_positiva (Estrada (2), [Carro, Nenhum , Nenhum , Carro ]) ] 

testsT11 :: Test 
testsT11 = TestLabel "Teste indicador do sentido" $ test ["Teste velocidade negativa Rio" ~: False ~=?  velocidade_positiva (Rio (-3), [Tronco, Tronco,Nenhum,Nenhum]) ]

testsT12 :: Test 
testsT12 = TestLabel "Teste indicador do sentido" $ test ["Teste velocidade postiiva Rio" ~: True ~=?  velocidade_positiva (Rio (3), [Tronco, Tronco,Nenhum,Nenhum]) ]
...
todos2 = runTestTT (TestList [testsT1, testsT2, testsT3, testsT4 , testsT5, testsT6 , testsT7 , testsT8, testsT9, testsT10, testsT11, testsT12, testsT13, testsT14 ])